    ...
    <PageShell>
      <section className="grid gap-6 lg:grid-cols-[1.15fr,0.85fr]">
        <GlassPanel className="overflow-hidden p-8 sm:p-10">
          <div className="flex items-center gap-3 text-cyan-100">
            ...
            <p className="font-accent text-xs uppercase tracking-[0.32em]">Cinematic Cricket Oracle</p>
          </div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/74">
            Think of any IPL player and let AI guess. The experience blends a stadium-sized neon interface, adaptive
            cricket questions, live voice moments, and premium motion design inspired by Akinator and modern sports games.
          </p>
        ...
        <GlassPanel className="p-6">
          <div className="flex items-center gap-3 text-cyan-100">
            ...
            <p className="font-accent text-xs uppercase tracking-[0.32em]">How It Works</p>
          </div>

          <div className="mt-6 space-y-4">
            {[
              "Think of any IPL player silently. No typing needed.",
              "The oracle asks human-like cricket questions one at a time.",
              "Answers narrow the field through decision logic plus OpenAI question phrasing.",
              "A dramatic reveal card lands on the final guess with stats and achievements."
            ].map((step, index) => (
              <div key={step} className="rounded-[24px] border border-white/10 bg-white/5 p-5">
                <p className="font-accent text-xs uppercase tracking-[0.24em] text-cyan-100/70">Step {index + 1}</p>
      ...
      <section className="mt-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="font-accent text-xs uppercase tracking-[0.32em] text-cyan-100/70">Team Portals</p>
          ...
          <p className="max-w-xl text-sm leading-6 text-white/68">
            Every team hub showcases its player roster in animated glass cards, with spotlight intros and full profile data.
          </p>
        </div>
